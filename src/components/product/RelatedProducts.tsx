...
export default function RelatedProducts({ currentProductId, categoryId }: RelatedProductsProps) {
  ...
  if (loading) {
    return (
      <div className="py-8">
        <h2 className="text-xl font-bold text-[#CC6600] mb-6">Customers who viewed this item also viewed</h2>
  ...
  return (
    <div className="py-8">
      <h2 className="text-xl font-bold text-[#CC6600] mb-6 tracking-tight">Customers who viewed this item also viewed</h2>
