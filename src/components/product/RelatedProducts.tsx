...
export default function RelatedProducts({ currentProductId, categoryId }: RelatedProductsProps) {
  ...
  if (loading) {
    return (
      <div className="pb-8">
        <h2 className="text-base sm:text-2xl md:text-xl font-bold text-gray-900 mb-4 md:mb-6 tracking-tight leading-snug">Customers who viewed this item also viewed</h2>
