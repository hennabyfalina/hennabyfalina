...
export default function HeroSection() {
  return (
    <section className="relative w-full bg-gradient-to-b from-gray-900 to-gray-800 text-white pt-8 pb-20 sm:pt-16 sm:pb-40 px-4 sm:px-8 flex flex-col items-center text-center overflow-hidden">
