...
export default function Error({
  ...
  return (
    <div className="min-h-[60vh] flex flex-col items-center justify-center bg-white px-4 py-16">
      <div className="flex flex-col items-center text-center max-w-lg">
        ...
        <div className="flex flex-wrap items-center justify-center gap-4">
          <button
            onClick={() => reset()}
            className="px-6 py-2.5 bg-[#FFD814] hover:bg-[#F7CA00] border border-[#FCD200] rounded-sm text-sm font-bold text-[#0F1111] transition-colors shadow-sm"
          >
            Try Again
          </button>
          <Link
